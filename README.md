...
> This site/repo is very old and unmaintained. CSS prefixes are rarely needed today. A static (and badly maintained) reference list is not the way: use Autoprefixer or other modern tooling instead...
...
Seriously: look into using Autoprefixer. It works with plain CSS, Sass, Less, you name it. You can even try out [a live demo](https://autoprefixer.github.io/)
